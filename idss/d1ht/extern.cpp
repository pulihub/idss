...
namespace d1ht {
    ...
    /**< mutexes */
    lock_t G_header_mutex, G_interval_mutex, G_thread_data_mutex, G_malloc_mutex;

    routing_table G_RT;     /**< routing table del processo */
    
    //manager_t G_Manager;    /**< query manager per la gestione delle query distribuite */
    
    QueryManager G_QM;  /**< query manager per la gestione delle query distribuite */
    
#if defined(DEBUG)
    selfmsg_t G_selfmsgs;
    lock_t G_selfmsgs_mutex;
    bool G_noport0 = true;
    bool G_succ_pred_err = false;
    bool G_xeq_find = false;
#endif
    ...
    stack<IPaddr> G_known_peers;    /**< elenco di nodi */

    /**< socket dei servers */
    int G_UDP_socket = 0, G_TCP_socket = 0, G_lookup_socket = 0; 
    PORTNO G_lookup_port = 0; 

    bool G_started = false;         /**< stati del processo */
    ...
    char** G_additional_argv[4];
    char G_additional_parms[4][12];

    join_t G_joining_peers;         /**< joining peers */
    probe_t G_probe;                /**< probe */
