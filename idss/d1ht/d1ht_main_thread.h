...
/**
 * @file d1ht_main_thread.h
 * @brief 
 */

#ifndef D1HT_MAIN_THREAD_H
#define D1HT_MAIN_THREAD_H

extern void* d1ht_main_thread(void* dummy);

namespace d1ht {

    struct main_thread_parms_t {
        int argc;
        char** argv;
    };

}
#endif /* D1HT_MAIN_THREAD_H */
