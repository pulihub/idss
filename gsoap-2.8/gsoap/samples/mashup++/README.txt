...
The mashupserver runs as a CGI application or as a stand-alone server when a
port argument is provided (use 8082), which can be easily changed into a
multi-threaded stand-alone Wserver as per online tutorials and shown in other
examples.
